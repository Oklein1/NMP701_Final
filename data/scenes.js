...
const data = {
    scene0: {
        location: 0,
        description: "Maps are fascinating artifacts not only in what they visualize, but more so in the presumptions they disclose. For contemporary map-makers we deal with arithmetic collection of data, representing points along a raster grid. We perform arithmetic transformations on such data in order to visualize them spherically. But this was not always the case, for points were not always derived from storage in computer memory, but from the stars. Let us look a bit closer into this matter from two points of view: functionality and theology",
        mapZoom: [
    ...
    scene2: {
        location: 2,    
        description: "Now, before us lies a star clock. On it we notice a number of different elements: the earth at the center, Roman gods encircling it and Zodiac signs bounding the entire heavens. Besides ornamentation, we may be left to ask: how is star-clock map intended to be read? What information about the world does it intend to tell?",
        mapZoom: [
    ...
    scene4: {
        location: 4,
        description: "As I'm sure many of you are thinking, we are currently looking upon a map visualizing the earth at the center of the known universe. The sun, the Deity riding the golden chariot, Solis, encircles us.",
        mapZoom: [
